    ...
    <div class="profile-wrapper">
        <div class="profile-wrapper-left">
            ...
            <div class="profile-info">
                ...
                <div style="background-image: url('<?php echo $p_photo; ?>')" alt="" class="profile-info-img-mobile"></div>
        ...
        <div class="profile-wrapper-right">
            ...
            <div class="s-profile-info-block">
                ...
                <div class="s-profile-info-block-content primary post"><?php echo $p_post; ?></div>
            </div>
            <div class="s-profile-info-block">
            ...
            <div class="profile-popup-buttons">
                <a class="btn share" data-fio="<?php echo $p_fio; ?>" onclick="share_dialog($(this).attr('data-url'), $(this).attr('data-fio'))">
